    ...
    <div class="col-12">
      <va-card class="card">
        ...
        >
          ...
          <Column field="bio" header="bio" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{ slotProps.data.bio }}
            </template>
          </Column>
          ...
          >
            <template #body="slotProps">
              {{ slotProps.data.email_verified }}
            </template>
          </Column>
          <Column field="status" header="Status" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              <Tag
                :value="slotProps.data.status == 1 ? 'Active' : slotProps.data.status == 0 ? 'In Active' : 'pending'"
