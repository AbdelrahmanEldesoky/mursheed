    ...
    <div class="col-12">
      <va-card class="card">
        ...
        >
          ...
          <Column field="create time" header="craete time" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
        ...
        <Dialog v-model:visible="deleteDialog" :style="{ width: '650px' }" header="Craete banner" :modal="true">
          <div>
        ...
        <Dialog v-model:visible="showbanner" :style="{ width: '650px' }" header="Craete banner" :modal="true">
          <div>
            <FileUpload id="password" @uploader="handleFileUpload" accept="image/*" required="true" multiple="true"
                        :custom-upload="true" autofocus >
              <template #empty>
                ...
                <img :src="banner_detailes.pictures?.photos[0]?.original_url" class="w-[200px] h-[90px] mb-3">
              </template>
            </FileUpload>
            <div class="mt-1 mb-5 text-red-500" v-if="error?.images">{{error.images[0]}}</div>
