...
const fetchData = () => {
  ...
  axios.get("/api/offers").then((res) => {
    loading.value = false
    elements.value = res.data.offers
...
const edit = (edit) => {
  user.value = {...edit}
  router.push({name:'offer-update',params:{'id':user.value.id} })
}
    ...
    <div class="col-12">
      <va-card class="card">
        ...
        >
          ...
          <Column field="number" header="Offer Number" :sortable="true" header-style="width:14%; min-width:10rem;">
