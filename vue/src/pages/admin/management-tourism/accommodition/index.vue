...
const fetchData = () => {
  ...
  axios.get("/api/accommodition").then((res) => {
    loading.value = false
    elements.value = res.data.accommmoditions
...
const openNew = () => {
router.push({ name: 'accommodition-create' })
}
...
const edit = (edit) => {
  ...
  router.push({name:'accommodition-update',params:{'id':user.value.id} })
        ...
        >
          <template #header>
            <div class="flex flex-column md:flex-row md:justify-between md:align-items-center">
              <h5 class="m-0">Manage Accommodition</h5>
          ...
          <Column field="name" header="name" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{ slotProps.data?.name[langSelected] }}
            </template>
          </Column>

          <Column field="description" header="description" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{ slotProps.data.description[langSelected] }}
            </template>
          </Column>
          <Column field="owner_info" header="owner info" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{ slotProps.data.owner_info[langSelected] }}
            </template>
          </Column>
          <Column field="address" header="address " :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{ slotProps.data.address[langSelected] }}
            </template>
          </Column>


          <Column field="aval_status" header="Avalabilty" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{ slotProps.data.aval_status }}
            </template>
          </Column>

          <Column field="info_status" header="Information datails on mobile status " :sortable="true"
                  header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{ slotProps.data.info_status }}
            </template>
          </Column>
