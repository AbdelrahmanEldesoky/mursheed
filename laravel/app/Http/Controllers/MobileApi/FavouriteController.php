...
$notify=0;
        ...
        if ($type == 0) {
            $flag = Favourite::where('service_id',$service_id)->where('service_type','App\Models\Driver')->count();
            if($flag != 0){
        ...
        if ($type == 1) {
            $flag = Favourite::where('service_id',$service_id)->where('service_type','App\Models\Guides')->count();
            if($flag != 0){
